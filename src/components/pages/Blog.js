    ...
    <div className="box-main">
      ...
      <p className="content">
        The fitness tracker is a fullstack app that helps a user track and aggregate their workout routines over time. For this piece I worked primarily on the backend database and routes linking to the front end JS.
          ...
          <ul className="nav">
                    <li>
                    <a href="https://github.com/aidanrich/fitness-tracker" className="heading" target="_blank" rel="noreferrer noopener">Git Repo</a>
                    </li>
                    <li>
                    <a href="https://vast-everglades-43611.herokuapp.com/" className="heading" target="_blank" rel="noreferrer noopener">Live Site</a>
                    </li>
                </ul>
    </div>
    <div className="box-main">
        ...
        <ul className="nav">
                    <li>
                    <a href="https://github.com/aidanrich/new2town" className="heading" target="_blank" rel="noreferrer noopener">Git Repo</a>
                    </li>
                    <li>
